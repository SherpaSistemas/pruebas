...
for row in rows:
    # print(row)
    cursorSQL.execute("INSERT INTO dbo.wpl (status,mono,lineitem,opnseq,duedate,availdate,begdate,enddate,wc,wcmach,suhr,runhr,pn,logondate,schdmach,qtyord,qtyrcd,qtyscrp,logonmach,firmschd,complete,tooling,available,opn,opndesc,extdesc,resreq,actsu,actrun,actlab,fslab,fsfod,fsvod,fspsvc,efficiency,resources,pursvc,vendor,pursvcpn,pursvclt,pursvcmult,pursvcpo,pursvcpl,moldid,remarks,labhr,runqty,flushlab,runahead,coil,die,userid,logoffdate,scheduled,psvcpono,pursvchist,psvcpackd,runaheadqt,pursvcprem,selected,maxlogon,labcode,level,shipid,testcode,optype,movetowc) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
